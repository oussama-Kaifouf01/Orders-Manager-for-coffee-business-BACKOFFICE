...
<tr>
      ...
      <th style="width: 125px;">Picture</th>
      <th style="width: 150px;">Price To Pay</th>
      <th style="width: 131px;">Quantity</th>
   ...
   <tbody>
   <?php
   $query_request = "SELECT * FROM `request` WHERE id_username='".$_SESSION['id']."';";
   ...
   $query_username = "SELECT * FROM admin_user WHERE id ='".$_SESSION['id']."';";
   ...
   ?>
      <tr class='<?php if($r_status=="Paid"){ echo "req-paid";  } elseif($r_status=="Ready"){  echo " req-ready"; } ?>'>
         <td><?php echo $r_id; ?></td>
...
<div>
<a href="/admin/views/add_req.php">
